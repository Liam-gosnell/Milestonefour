"""
Django settings for dropdesign project.
...
SECRET_KEY = '**!ytja3++hs@+*l^-v-3coxg8=+j=r2)-s9f51od(svenwuiz'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['designdrop.herokuapp.com', 'localhost']
...
DEFAULT_FROM_EMAIL = 'DESIGNDROP@example.com'
